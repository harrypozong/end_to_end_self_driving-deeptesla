...
for epoch_id in epoch_ids:
    ...
    vid_path = utils.join_dir('C:/Users/ccc/Downloads/udacity-capstone-deeptesla-master/epochs/', 'epoch{:0>2}_front.mkv'.format(epoch_id))
    print(vid_path)
    ...
    for frame_id in range(frame_count):
        ...
        img = img[None,:,:,:]
        deg = float(model1.predict(img, batch_size=1))
