...
def visualize(epoch_id, machine_steering, out_dir, perform_smoothing=False,
    ...
    vw = cv2.VideoWriter(out_path, cv2.VideoWriter_fourcc('X','V','I','D'), 30, vid_size)
    ...
    for f_cur in range(len(machine_steering)):
        ...
        wimg = imread("C:/Users/ccc/Downloads/udacity-capstone-deeptesla-master/images/wheel-tesla-image-150.png", cv2.IMREAD_UNCHANGED)
        ...
        ####################### text ######################
        timg_green_agree = imread("C:/Users/ccc/Downloads/udacity-capstone-deeptesla-master/images/text-green-agree.png", cv2.IMREAD_UNCHANGED)
        timg_ground_truth = imread("C:/Users/ccc/Downloads/udacity-capstone-deeptesla-master/images/text-ground-truth.png", cv2.IMREAD_UNCHANGED)
        timg_learned_control = imread("C:/Users/ccc/Downloads/udacity-capstone-deeptesla-master/images/text-learned-control.png", cv2.IMREAD_UNCHANGED)
        timg_red_disagree = imread("C:/Users/ccc/Downloads/udacity-capstone-deeptesla-master/images/text-red-disagree.png", cv2.IMREAD_UNCHANGED)
        timg_tesla_control_autopilot = imread("C:/Users/ccc/Downloads/udacity-capstone-deeptesla-master/images/text-tesla-control-autopilot.png", cv2.IMREAD_UNCHANGED)
        timg_tesla_control_human = imread("C:/Users/ccc/Downloads/udacity-capstone-deeptesla-master/images/text-tesla-control-human.png", cv2.IMREAD_UNCHANGED)
...
def get_model():
    ...
    model_path ='C:/Users/ccc/Downloads/udacity-capstone-deeptesla-master/models/model.json'
    param_path ='C:/Users/ccc/Downloads/udacity-capstone-deeptesla-master/models/model.h5'
    print(model_path)
